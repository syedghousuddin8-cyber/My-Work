    ...
    <View style={styles.container}>
      ...
      <View style={styles.menu}>
        <TouchableOpacity style={styles.menuItem}>
          <Icon name="business-outline" size={24} color={colors.textPrimary} />
          <Text style={styles.menuText}>Restaurant Info</Text>
          <Icon name="chevron-forward" size={20} color={colors.textTertiary} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem}>
          <Icon name="time-outline" size={24} color={colors.textPrimary} />
          <Text style={styles.menuText}>Operating Hours</Text>
          <Icon name="chevron-forward" size={20} color={colors.textTertiary} />
        </TouchableOpacity>
        <TouchableOpacity style={styles.menuItem}>
